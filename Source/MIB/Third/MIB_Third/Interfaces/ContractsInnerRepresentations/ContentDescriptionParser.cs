...
namespace Interfaces.ContractsInnerRepresentations
{
    public static class ContentDescriptionParser
    {
        ...
        public static List<ContentDescriptionAttribute> Parse(string contentDescription)
        {
            ...
            XDocument doc = GetContentDescriptionRepresentation(contentDescription);
        ...
        public static XDocument GetContentDescriptionRepresentation(string contentDescription)
        {

            return XDocument.Parse(contentDescription);
